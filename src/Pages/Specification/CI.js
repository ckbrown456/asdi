    ...
    <React.Fragment style={{padding: '3%'}}>
      ...
      <Container disableGutters maxWidth="m" component="main" sx={{ pt: 8, pb: 6 }} >
        ...
        >
          ...
          <b><u>Construction / Implementation</u></b><br /><br />
          <b>What is the ASDI Implementation Specification?</b><br />
          The ASDI Implementation Specification is a set of practices used to scale the implementation phase of a Traditional SDLC down to a short yet comprehensive operation. The goal of this specification is to provide developers and managers with innovative techniques to accelerate the process of coding, verifying, testing and debugging software.<br /><br />
          <b>Overview</b><br />
          Traditional practices involved in Implementation will be stated over the course of this document. <br />
          ...
          Accelerated approaches fulfill the concepts and goals of traditional practices but are refined to speed up the Implementation phase.<br /><br />
