    ...
    <React.Fragment style={{padding: '3%'}}>
      ...
      <Container disableGutters maxWidth="m" component="main" sx={{ pt: 8, pb: 6 }} >
        ...
        >
          ...
          <b><u>Architecture & Design</u></b><br /><br />
          <b>What is the ASDI Architecture and Design Specification?</b><br />
          The ASDI Architecture & Design(AD) Specification is a set of practices used to scale the AD phase of a Traditional SDLC down to a short yet comprehensive operation. The goal of this specification is to provide developers and managers with innovative techniques to accelerate the process of depicting relationships between components, creating classes, creating methods and creating objects for construction.<br /><br />
          <b>Overview</b><br />
          Traditional practices involved in Architecture & Design will be stated over the course of this document. <br />
          ...
          Accelerated approaches fulfill the concepts and goals of traditional practices but are refined to speed up the AD phase.<br /><br />
